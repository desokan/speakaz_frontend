...
const MainNavigation = () => {
  return (
    <Disclosure as="header" className="bg-gray-800 fixed w-full z-40">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-4 lg:divide-y lg:divide-gray-700 lg:px-8">
            <div className="relative flex h-16 justify-between">
              ...
              {/* Search */}
              <div className="relative z-0 flex flex-1 items-center justify-start px-2 sm:px-16 lg:pl-20 lg:pr-0 sm:absolute sm:inset-0">
                <div className="w-full sm:max-w-xs min-w-full">
